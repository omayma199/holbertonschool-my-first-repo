...
/**
 * topple_sandpiles - any integer in grid over 4 is "toppled," or reduced by
 * 4 and its neighbors all increased by 1
 *
 ...
 */
void topple_sandpiles(int grid[3][3], int t_points[9][2])
{
	int i, j, k;
 ...
 * according to a "sandpile" cellular automata scheme (values over 4 have 4
 * subtracted and 1 is added to all 2-4 neighboring cells)
 *
